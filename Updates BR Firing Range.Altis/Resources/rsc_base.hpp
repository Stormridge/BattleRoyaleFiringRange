/*
	...
	Description: Dialog base classes
...
class RscCombo
{
	...
	access = 0;
	type = 4;
	colorSelect[] =   // Selected text color
	{
		0,
		0,
		0,
	...
	colorBackground[] = // unselect background color
	{
		0,
		0,
		0,
	...
	maxHistoryDelay = 1;
	class ComboScrollBar	// full bar color (not the runner)
	{
